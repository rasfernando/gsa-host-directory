...
// Handles the magic-link redirect and starts a session.
// Supports both formats Supabase can send:
//  - PKCE flow (default email template): ?code=...
//  - Token-hash flow (custom email template): ?token_hash=...&type=email
